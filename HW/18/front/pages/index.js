            ...
            <div className="px-4 py-5 flex flex-col">
                <div className="p-4 flex flex-col gap-4 bg-[#293145] rounded-lg">
                    <div
                        ...
                        <button className="w-4 h-4 bg-transparent relative top-0 right-0">
                            <Image alt="bellIcon" src={bellIcon} className="w-4 h-4"/>
                            <div className="w-[10px] h-[10px] bg-[#E95151] rounded-full flex items-center justify-center text-[8px] font-normal absolute top-[-2px] right-[-2px]">4</div>
                        </button>
